...
export class Trav5AddSkillDialog extends Application {
    static get defaultOptions() {
        const options = super.defaultOptions;
        options.template = "systems/trav5/templates/add-skill-dialog.html";
        options.width = "auto";
        options.height = "auto";
    ...
    constructor(actor, skillId, skill, specId, spec) {
        super();
        console.log("Trav5AddSkillDialog:");
        ...
        if (this.isEdit) {
            this.options.title = game.i18n.localize("TRAV5.EditSkill.Edit");
            this.options.title += " - " + skillId;
            if (spec) {
                this.options.title += " (" + specId + ")";
            }
        } else {
            this.options.title = game.i18n.localize("TRAV5.EditSkill.Add");
        }
        ...
        this.icon = "systems/trav5/icons/skills/new.svg";
        this.parent = "";
        this.parentLabel = "";
        this.value = 0;
        this.trained = false;
