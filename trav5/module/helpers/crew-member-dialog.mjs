...
export class Trav5CrewMemberDialog extends Application {
    static get defaultOptions() {
        const options = super.defaultOptions;
        options.template = "systems/trav5/templates/crew-member-dialog.html";
        options.width = "600px";
        options.height = "auto";
    ...
    constructor(actorCrew, actorShip, actorSheet) {
        super();
        console.log("Trav5CrewMemberDialog:");
