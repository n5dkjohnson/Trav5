...
export class Trav5QuantityDialog extends Application {
    static get defaultOptions() {
        const options = super.defaultOptions;
        options.template = "systems/trav5/templates/quantity-dialog.html";
        options.width = "400";
        options.height = "auto";
    ...
    async onSaveClick(event, html) {
        ...
        if (number >= this.srcItem.system.quantity) {
            ...
            if (this.destItem.system.status) {
                this.destItem.system.status = Trav5Item.OWNED;
...
window.Trav5QuantityDialog = Trav5QuantityDialog;
