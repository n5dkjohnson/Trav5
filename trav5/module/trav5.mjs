...
import { Trav5Actor } from "./documents/actor.mjs";
import { Trav5Item } from "./documents/item.mjs";
// Import sheet classes.
import { Trav5ActorSheet } from "./sheets/actor-sheet.mjs";
import { Trav5NPCActorSheet } from "./sheets/actor-sheet.mjs";
import { Trav5CreatureActorSheet } from "./sheets/actor-sheet.mjs";
import { Trav5ItemSheet } from "./sheets/item-sheet.mjs";
import { Trav5EffectSheet } from "./sheets/effect-sheet.mjs";
...
Hooks.once('init', async function() {
  ...
  // accessible in global contexts.
    ...
    game.settings.register("trav5", "systemSchemaVersion", {
        config: false,
        scope: "world",
        type: Number,
        default: 0
    ...
    game.settings.register('trav5', 'verboseSkillRolls', {
        name: game.i18n.localize("TRAV5.Settings.Verbose.Name"),
        hint: game.i18n.localize("TRAV5.Settings.Verbose.Hint"),
        scope: 'world',
        config: true,
        type: Boolean,
        default: true,
    ...
    game.settings.register('trav5', 'useChatIcons', {
        name: game.i18n.localize("TRAV5.Settings.ChatIcons.Name"),
        hint: game.i18n.localize("TRAV5.Settings.ChatIcons.Hint"),
        scope: 'world',
        config: true,
        type: Boolean,
        default: true,
    ...
    game.settings.register('trav5', 'useEncumbrance', {
        name: game.i18n.localize("TRAV5.Settings.UseEncumbrance.Name"),
        hint: game.i18n.localize("TRAV5.Settings.UseEncumbrance.Hint"),
        scope: 'world',
        config: true,
        type: Boolean,
        default: true
    });
    game.settings.register('trav5', 'quickRolls', {
        name: game.i18n.localize("TRAV5.Settings.QuickRolls.Name"),
        hint: game.i18n.localize("TRAV5.Settings.QuickRolls.Hint"),
        scope: 'client',
        config: true,
        type: Boolean,
        default: false,
    ...
    game.settings.register('trav5', 'skillColumns', {
        name: game.i18n.localize("TRAV5.Settings.SkillColumns.Name"),
        hint: game.i18n.localize("TRAV5.Settings.SkillColumns.Hint"),
        scope: 'client',
        config: true,
        type: String,
        choices: {
            "2": game.i18n.localize("TRAV5.Settings.SkillColumns.Values.Two"),
            "3": game.i18n.localize("TRAV5.Settings.SkillColumns.Values.Three"),
            "4": game.i18n.localize("TRAV5.Settings.SkillColumns.Values.Four")
        },
        default: "4"
    });
    game.settings.register('trav5', 'skillFormat', {
        name: game.i18n.localize("TRAV5.Settings.SkillFormat.Name"),
        hint: game.i18n.localize("TRAV5.Settings.SkillFormat.Hint"),
        scope: 'client',
        config: true,
        type: String,
        choices: {
            "rows": game.i18n.localize("TRAV5.Settings.SkillFormat.Values.Rows"),
            "columns": game.i18n.localize("TRAV5.Settings.SkillFormat.Values.Columns")
        },
        default: "columns"
    });

    game.settings.register('trav5', 'currentYear', {
       name: game.i18n.localize("TRAV5.Settings.CurrentYear.Name"),
       hint: game.i18n.localize("TRAV5.Settings.CurrentYear.Hint"),
       scope: 'world',
       config: true,
       type: Number,
       default: 1105
    });
    game.settings.register('trav5', 'currentDay', {
        name: game.i18n.localize("TRAV5.Settings.CurrentDay.Name"),
        hint: game.i18n.localize("TRAV5.Settings.CurrentDay.Hint"),
        scope: 'world',
        config: true,
        type: Number,
        default: 1
    });
    game.settings.register('trav5', 'autoResizeSpacecraft', {
        name: game.i18n.localize("TRAV5.Settings.AutoResizeSpacecraft.Name"),
        hint: game.i18n.localize("TRAV5.Settings.AutoResizeSpacecraft.Hint"),
        scope: 'world',
        config: true,
        type: Boolean,
        default: true
    });
    game.settings.register('trav5', 'playerSheetNotification', {
        name: game.i18n.localize("TRAV5.Settings.PlayerSheetNotification.Name"),
        hint: game.i18n.localize("TRAV5.Settings.PlayerSheetNotification.Hint"),
        scope: 'world',
        config: true,
        choices: {
            "private": game.i18n.localize("TRAV5.Settings.SheetNotification.Values.Private"),
            "public": game.i18n.localize("TRAV5.Settings.SheetNotification.Values.Public"),
            "gm": game.i18n.localize("TRAV5.Settings.SheetNotification.Values.GM")
        },
        default: "gm"
    });
    game.settings.register('trav5', 'gmSheetNotification', {
        name: game.i18n.localize("TRAV5.Settings.GMSheetNotification.Name"),
        hint: game.i18n.localize("TRAV5.Settings.GMSheetNotification.Hint"),
        scope: 'world',
        config: true,
        choices: {
            "private": game.i18n.localize("TRAV5.Settings.SheetNotification.Values.Private"),
  ...
  CONFIG.Actor.documentClass = Trav5Actor;
  CONFIG.Item.documentClass = Trav5Item;
  CONFIG.ActiveEffect.documentClass = Trav5Effect;
  ...
  Actors.registerSheet("trav5", Trav5ActorSheet, { label: "Traveller Sheet", makeDefault: true });
  Actors.registerSheet("trav5", Trav5NPCActorSheet, { label: "NPC Sheet", types: [ "npc"], makeDefault: false });
  Actors.registerSheet("trav5", Trav5CreatureActorSheet, { label: "Creature Sheet", types: [ "creature"], makeDefault: false });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("trav5", Trav5ItemSheet, { label: "Item Sheet", makeDefault: true });
  DocumentSheetConfig.unregisterSheet(ActiveEffect, "core", ActiveEffectConfig);
  DocumentSheetConfig.registerSheet(ActiveEffect, "trav5", Trav5EffectSheet, { makeDefault: true});
//  ActiveEffects.unregisterSheet("core", ActiveEffectSheet);
//  ActiveEffects.registerSheet("trav5", Trav5EffectSheet, { makeDefault: true });


    // Sockets
    game.socket.on("system.trav5", (data) => {
...
Hooks.on('ready', () => {
    if (game.user.isGM) {
        ...
        const currentVersion = parseInt(game.settings.get("trav5", "systemSchemaVersion"));
        ...
        if (!currentVersion || currentVersion < LATEST_SCHEMA_VERSION) {
            ...
            game.settings.set("trav5", "systemSchemaVersion", LATEST_SCHEMA_VERSION);
        }
    }
...
Hooks.on("createItem", (item) => {
    if (item.img === "icons/svg/item-bag.svg") {
        if (item.type === "weapon") {
            item.img = "systems/trav5/icons/items/gun-slug.svg";
        } else if (item.type === "armour") {
            item.img = "systems/trav5/icons/items/armour-light.svg";
        } else if (item.type === "augment") {
            item.img = "systems/trav5/icons/items/cybernetic.svg";
        } else if (item.type === "cargo") {
            item.img = "systems/trav5/icons/cargo/cargo.svg";
        } else if (item.type === "term") {
            item.img = "systems/trav5/icons/misc/career.svg";
        } else if (item.type === "role") {
            item.img = "systems/trav5/icons/items/crew_role.svg";
        } else if (item.type === "software") {
            item.img = "systems/trav5/icons/items/software.svg";
        } else {
            item.img = "systems/trav5/icons/items/item.svg";
        }
...
Hooks.on("createActor", (actor) => {
    ...
    if (actor.type === "traveller" || actor.type === "npc" || actor.type === "package") {
        ...
        for (let c of [
                "STR", "DEX", "AGI", "GRA", "END", "STA", "VIG", "INT", "EDU", "TRA", 
                "INS", "SOC", "CHA", "CAS", "STY", "PSI", "CUR", "NSG", "LCK", "FAM", 
                "TER", "WLT", "MRL", "RES", "FOL", "REP"
            ]) {
            ...
            actor.system.characteristics[c] = JSON.parse(
                JSON.stringify(TRAV5.CHARACTERISTICS[c])
            );
    ...
    if (actor.type === "traveller" || actor.type === "npc" || actor.type === "package" || actor.type === "creature") {
        ...
        for (let s in TRAV5.SKILLS) {
            ...
            if (!actor.system.skills[s].icon) {
                actor.system.skills[s].icon = `systems/trav5/icons/skills/${s}.svg`;
            }
        }
    ...
    if (actor.img === "icons/svg/mystery-man.svg") {
        ...
        if (actor.type === "creature") {
            actor.img = `systems/trav5/icons/actors/creature-${colours[colours.length * Math.random() | 0]}.svg`;
        } else if (actor.type === "traveller" || actor.type === "npc") {
            actor.img = `systems/trav5/icons/actors/traveller-${colours[colours.length * Math.random() | 0]}.svg`;
        } else if (actor.type === "package") {
            actor.img = `systems/trav5/icons/actors/traveller-grey.svg`;
        } else if (actor.type === "spacecraft") {
            actor.img = `systems/trav5/images/tokens/spacecraft/white/far_trader.webp`;
        } else if (actor.type === "vehicle") {
            actor.img = `systems/trav5/images/tokens/vehicles/white/jeep.webp`;
        } else {
            actor.img = "systems/trav5/icons/actors/traveller-red.svg";
        }
...
Hooks.on("preUpdateActor", (actor, data, options, userId) => {
    if (data?.system?.damage) {
        ...
        switch (atZero) {
            case 2:
                actor.setFlag("trav5", "unconscious", true);
                actor.unsetFlag("trav5", "disabled");
                actor.unsetFlag("trav5", "dead");
                break;
            case 3:
                actor.setFlag("trav5", "disabled", true);
                break;
            default:
                actor.unsetFlag("trav5", "unconscious");
                actor.unsetFlag("trav5", "disabled");
                actor.unsetFlag("trav5", "dead");
        }
        ...
        if (actorType === "traveller") {
            ...
            if (data.actor.system.status) {
                if (actor.system.status.woundLevel > 1) {
                    tokenObject.toggleEffect("systems/trav5/icons/effects/unconscious.svg", {
                        "overlay": true,
                        "active": false
                    });
                }
            ...
            if (hits <= 0) {
                // Token is dead.
                text += `They are dead.`;
                tokenObject.toggleEffect("systems/trav5/icons/effects/dead.svg", { "overlay": true, "active": true });
                tokenObject.toggleEffect("systems/trav5/icons/effects/unconscious.svg", { "overlay": true, "active": false });
                tokenObject.toggleEffect("systems/trav5/icons/effects/injured.svg", { "overlay": false, "active": false });
                tokenObject.toggleEffect("systems/trav5/icons/effects/destroyed.svg", { "overlay": true, "active": false });
            } else if (hits <= tenth) {
                // Token is unconscious.
                text += `They are unconscious.`;
                tokenObject.toggleEffect("systems/trav5/icons/effects/dead.svg", { "overlay": true, "active": false });
                tokenObject.toggleEffect("systems/trav5/icons/effects/unconscious.svg", { "overlay": true, "active": true });
                tokenObject.toggleEffect("systems/trav5/icons/effects/injured.svg", { "overlay": false, "active": false });
                tokenObject.toggleEffect("systems/trav5/icons/effects/destroyed.svg", { "overlay": true, "active": false });
            } else if (hits <= half) {
                // Token is bloodied.
                ...
                tokenObject.toggleEffect("systems/trav5/icons/effects/dead.svg", { "overlay": true, "active": false });
                tokenObject.toggleEffect("systems/trav5/icons/effects/unconscious.svg", { "overlay": true, "active": false });
                tokenObject.toggleEffect("systems/trav5/icons/effects/injured.svg", { "overlay": false, "active": true });
                tokenObject.toggleEffect("systems/trav5/icons/effects/destroyed.svg", { "overlay": true, "active": false });
            } else {
                // Token is okay.
                tokenObject.toggleEffect("systems/trav5/icons/effects/dead.svg", { "overlay": true, "active": false });
...
Hooks.on("combatTurn", (combat, data, options) => {
    ...
    combatant.unsetFlag("trav5", "reaction");

    // If stunned, reduce rounds left to be stunned
    let stunned = combatant.getFlag("trav5", "stunned");
    if (stunned) {
        let rounds = combatant.getFlag("trav5", "stunnedRounds");
        rounds = rounds?parseInt(rounds):0;

        if (--rounds < 1) {
            combatant.unsetFlag("trav5", "stunned");
            combatant.unsetFlag("trav5", "stunnedRounds");
        } else {
            combatant.setFlag("trav5", "stunnedRounds", rounds);
        }
    }
});
...
async function createTravellerMacro(data, slot) {
    ...
    if (data.type === "Item") {
        ...
        let command = null;
        if (item.type === "weapon") {
            command = `game.trav5.rollAttackMacro('${item.name}')`;
        } else {
        ...
        if (!actor) {
            ui.notifications.warn(game.i18n.localize("TRAV5.Warn.HotBar.NewActor"));
            return false;
        }
        let skill = actor.system.skills[dragData.skillName];
        let label = actor.getSkillLabel(dragData.skillName);

        const command = `game.trav5.rollSkillMacro('${dragData.skillName}')`;
        ...
        ui.notifications.info(game.i18n.format("TRAV5.Info.HotBar.AssignedSkill", { skill: label}));
        game.user.assignHotbarMacro(macro, slot);
        return false;
    }
...
function rollSkillMacro(skillName) {
  ...
  if (!actor) {
      ui.notifications.warn(game.i18n.localize("TRAV5.Warn.HotBar.SelectActorSkill"));
      return;
  }

  if (game.settings.get("trav5", "quickRolls")) {
      rollSkill(actor, skillName);
  } else {
      new Trav5SkillDialog(actor, skillName).render(true);
  }
}
...
function rollAttackMacro(itemName) {
    ...
    if (!actor) {
        return ui.notifications.warn(game.i18n.format("TRAV5.Warn.HotBar.SelectActorItem", {item: itemName }));
    }

    let item = actor.items.find(i => (i.name === itemName));
    if (!item) {
        return ui.notifications.warn(game.i18n.format("TRAV5.Warn.HotBar.ActorNotHaveItem", {actor: actor.name, item: itemName }));
    }

    new Trav5AttackDialog(actor, item).render(true);
}
...
Handlebars.registerHelper('skillLabel', function(data, skill, spec) {
    if (data && data.skills && skill) {
        ...
        if (data.settings.rollType === "boon") {
            type = ` [${game.i18n.localize("TRAV5.TravellerSheet.Boon")}]`;
        } else if (data.settings.rollType === "bane") {
            type = ` [${game.i18n.localize("TRAV5.TravellerSheet.Bane")}]`;
        }
        ...
        if (skill.trained) {
            ...
            return `${cha} + ${skillLabel(skill)}  (${game.i18n.localize("TRAV5.TravellerSheet.Untrained")}) ${type}`;
        }
    } else {
        return "Roll";
    }
...
Handlebars.registerHelper('isItemEquipped', function(item) {
    if (item.system.status === Trav5Item.EQUIPPED) {
        return true;
    }
    return false;
});
...
Handlebars.registerHelper('isItemCarried', function(item) {
    if (item.system.status === Trav5Item.CARRIED) {
        return true;
    }
    return false;
});
...
Handlebars.registerHelper('isItemOwned', function(item) {
    if (item.system.status === Trav5Item.EQUIPPED || item.system.status === Trav5Item.CARRIED) {
        return false;
    }
...
Handlebars.registerHelper('equipItem', function(item) {
    if (item.system.status === Trav5Item.EQUIPPED || item.system.weight === undefined) {
        return "";
    }
...
Handlebars.registerHelper('deactivateItem', function(item) {
    if (!item.system.status || item.system.status === Trav5Item.CARRIED || item.system.status === Trav5Item.OWNED || item.system.weight === undefined) {
        return "";
    }
...
Handlebars.registerHelper('storeItem', function(item) {
    if (!item.system.status || item.system.status === Trav5Item.OWNED || item.system.weight === undefined) {
        return "";
    }
...
Handlebars.registerHelper('carryItem', function(item) {
    if (item.system.status === Trav5Item.CARRIED || item.system.weight === undefined) {
        return "";
    }
...
Handlebars.registerHelper('skillListClasses', function() {
    ...
    let columns = parseInt(game.settings.get("trav5", "skillColumns"));
    let format = game.settings.get("trav5", "skillFormat");
...
Handlebars.registerHelper('hasStatus', function(actor) {
    const status = actor.flags.trav5;
...
Handlebars.registerHelper('showStatus', function(actor, status) {
   let type = "statusWarn";
   let label = game.i18n.localize("TRAV5.TravellerSheet.StatusLabel."+status);

   if (status === "fatigued") {
       label += ` <i class="fas fa-xmark statusFatigued"> </i>`;
   } else if (status === "stunned") {
       if (parseInt(actor.getFlag("trav5", "stunnedRounds")) > 0) {
           label += ` (${actor.getFlag("trav5", "stunnedRounds")})`;
       }
       ...
       if (!(parseInt(actor.getFlag("trav5", "reaction")) < 0)) {
           return "";
       }
       label += ` (${actor.getFlag("trav5", "reaction")})`;
...
Handlebars.registerHelper('showItemStatus', function(item, status) {
    ...
    if (status === "damaged") {
        ...
        if (parseInt(item.getFlag("trav5", "damaged")) !== 0) {
            label += ` (${item.getFlag("trav5", "damaged")})`;
        }
...
Handlebars.registerHelper('showCriticals', function(actor) {
  let html = "";
  for (let c in TRAV5.SPACECRAFT_CRITICALS) {
      let severity = actor.flags.trav5["crit_"+c];
      if (severity) {
          ...
          let label = game.i18n.localize("TRAV5.Spacecraft.Criticals."+c);
          label += ` ${severity}`;
...
Handlebars.registerHelper('showCrewInfo', function(actorShip, actorCrew) {
    ...
    if (!html) {
        html =  game.i18n.localize("TRAV5.Role.NoRoleAssigned");
    }
    return html;
});
...
Handlebars.registerHelper('skillToLabel', function(skillName) {
    ...
    if (skills[skillId]) {
        ...
        if (!label) {
            label = game.i18n.localize("TRAV5.Skills." + skillId);
        }
        if (specId && skills[skillId].specialities) {
            if (skills[skillId].specialities[specId]) {
                if (skills[skillId].specialities[specId].label) {
                    ...
                    label += ` (${game.i18n.localize("TRAV5.Skills." + specId)})`;
                }
            }
        }
    } else {
...
Handlebars.registerHelper('showBehaviours', function(key, behaviours) {
   ...
   for (let b in list) {
       if (list[b].length > 0) {
           let style = "";
           if (CONFIG.TRAV5.CREATURES.behaviours[list[b]]?.group) {
               style = CONFIG.TRAV5.CREATURES.behaviours[list[b]].group;
           }
           html += `<span class='behaviour-item ${style?"behaviour-style-"+style:""}' title='${game.i18n.localize("TRAV5.Creature.BehaviourText." + list[b])}' data-behaviour-id='${list[b]}'>`;
           html += `${game.i18n.localize("TRAV5.Creature.Behaviour." + list[b])} `;
           if (key.owner) {
...
Handlebars.registerHelper('showTraits', function(key, traits) {
    ...
    for (let i in list) {
        if (list[i].length > 0) {
            ...
            let data = CONFIG.TRAV5.CREATURES.traits[trait];
            if (data) {
                ...
                html += `&nbsp;${game.i18n.localize("TRAV5.Creature.Trait." + trait)} `;
                if (data.choices) {
                    html += `(${game.i18n.localize("TRAV5.Creature.TraitChoice."+trait+"."+data.choices[value])}) `;
                } else if (value) {
...
Handlebars.registerHelper('showWeaponTraits', function(key, traits) {
    ...
    for (let i in list) {
        if (list[i].length > 0) {
            ...
            let data = CONFIG.TRAV5.WEAPONS.traits[trait];
            if (!data) {
                trait = trait.toLowerCase();
                data = CONFIG.TRAV5.WEAPONS.traits[trait];
            }
            if (data) {
                html += `<span class='pill weapon-pill' data-trait-id='${trait}' title='${game.i18n.localize("TRAV5.Item.WeaponTrait.Text."+trait)}'>`;
                if (key.owner) {
                ...
                html += `&nbsp;${game.i18n.localize("TRAV5.Item.WeaponTrait.Label." + trait)} `;
                if (value) {
                    html += `${value} `;
                }
                if (key.owner) {
...
Handlebars.registerHelper('showCargoTraits', function(key, traits) {
    ...
    for (let i in list) {
        if (list[i].length > 0) {
            ...
            html += `<span class='pill cargo-pill' data-trait-id='${trait}' title='${game.i18n.localize("TRAV5.Trade."+trait)}'>`;
            if (key.owner) {
                value = parseInt(value);
                if (value > -12) {
                    html += `<i class="fas fa-minus trait-minus"> </i>`;
            ...
            html += `&nbsp;${game.i18n.localize("TRAV5.Trade." + trait)} `;
            if (value) {
                html += `${(value>=0)?"+":""}${value} `;
            }
            if (key.owner) {
...
Handlebars.registerHelper('showAdvantages', function(key, traits) {
   ...
   let html = "";
   let list = traits.split(",");
   let data = CONFIG.TRAV5.SPACECRAFT_ADVANTAGES[hardware.system];
   ...
   for (let i in list) {
       if (list[i].length > 0) {
           ...
           html += game.i18n.localize("TRAV5.Spacecraft.Advantages." + adv);
